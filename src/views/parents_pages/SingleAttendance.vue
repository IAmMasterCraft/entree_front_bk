  ...
  methods: {
    ...
    async getAttendance() {
      ...
      try {
        const config = {
          method: "get",
          url: `${/*window.location.origin*/'https://entreelab.org'}/src/api/attendance/get-student/${this.$route.params.id}`,
          data: null,
    ...
    async SearchAttendance (date) {
        ...
        try {
            const config = {
            method: "get",
            url: `${/*window.location.origin*/'https://entreelab.org'}/src/api/attendance/student-attendance/${this.$route.params.id}/${revert}`,
            data: null,
            headers: { Authorization: localStorage.getItem("token") },
            withCredentials: false,
            };
