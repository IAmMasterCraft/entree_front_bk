            ...
            <CCardHeader>
              <CRow>
                ...
                <CCol lg="6" v-if="user === 2">
                  <AddParent :showModal="showModal" @show-modal="toggleModal" @show-parent="updateParent" />
                  <CButton
                    color="success"
                    variant="outline"
                    square
  ...
  methods: {
    ...
    async allParents () {
      try {
        const config = {
          method: "get",
          url: `${/*window.location.origin*/'https://entreelab.org'}/src/api/parents`,
          data: null,
